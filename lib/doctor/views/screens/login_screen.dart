    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          icon: const Icon(Icons.arrow_back,color: Color(0xFF0E5C6E),),
        ),
      ),
      body: SingleChildScrollView(
        ...
        child: SafeArea(
            child: Center(
              child: Column(
                children: [
                  Image.asset("assets/images/vector/docterlogin.png",width:double.infinity,height: 320,),
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    prefixIcon: Icon(Icons.lock_outline,color: Color(0xff117790),),
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Center(child: isLoading ? CircularProgressIndicator(color: Colors.black,) :Text("Log in",style:TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 22),)),
                                ),
                              ),
